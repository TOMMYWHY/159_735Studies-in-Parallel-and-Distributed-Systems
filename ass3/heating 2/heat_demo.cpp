...
//        std::cout <<"id:"<< id << ";  step: "<< step  << std::endl;
//        std::cout << "id:"<< id << " ; p_start1 :"  << p_start1 << "; p_end1 : "<< p_end1 << std::endl;
//        std::cout<<"-----" <<std::endl;
//        std::cout <<std::endl;
//        std::cout << "id:"<< id << " ; p_start2 :"  << p_start2 << "; p_end2 : "<< p_end2<< std::endl;
...
//                printf("i = %d, I am part2 Thread %d\n", y, omp_get_thread_num());
